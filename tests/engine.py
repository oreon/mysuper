...
class ExecutionEngine(hitchtest.ExecutionEngine):
    ...
    def set_up(self):
        ...
        postgres_user = hitchpostgres.PostgresUser("mysuper", "password")

        self.services['Postgres'] = hitchpostgres.PostgresService(
            postgres_package=postgres_package,
            users=[postgres_user, ],
            databases=[hitchpostgres.PostgresDatabase("mysuper", postgres_user), ]
        )
        ...
        self.services['Celery'] = hitchpython.CeleryService(
            python=python_package.python,
            app="mysuper.taskapp", loglevel="INFO",
            needs=[
